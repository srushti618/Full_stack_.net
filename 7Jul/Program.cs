...
//         Console.WriteLine("Your are Pass and You marks is "+(marks)+"your grade is C");
//        }
//        else if(marks>50 && marks<=70){
// Console.WriteLine("Your are Pass and You marks is "+(marks)+"your grade is B");
//        }
//        else if(marks>70 && marks<=100){
//         Console.WriteLine("Your are Pass and You marks is "+(marks)+"your grade is A");
//        }
//        else{
//         Console.WriteLine("Your are Fail and You marks is "+(marks));
//        }
